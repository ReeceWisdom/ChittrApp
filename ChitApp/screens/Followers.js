...
class FollowersPage extends Component {
  ...
  getData(id) {
    ...
    console.log("Followers Request:", request);
    ...
    .then((responseJson) => {
      ...
      console.log("JSON Request Results:", this.state.followersList);
    })
    .catch((error) => {
    ...
    return (
      <View style={{ flex: 1, flexDirection: 'column', marginBottom: 3 }}>
        <View style={{ backgroundColor: '#1DCAFF', alignItems: 'center', justifyContent: 'center', borderWidth: 5, borderColor: '#000000', borderLeftWidth: 1, borderRightWidth: 1 }}>
          <Text style={{ color: '#000000', fontSize: 24, fontWeight: 'bold', height: 50, paddingTop: 8 }}>~~~ Followers ~~~</Text>
        </View>
